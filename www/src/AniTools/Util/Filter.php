...
final class Filter
{
    private const FILTER_TYPES = [
        ...
        'airingStartMin' => 'fuzzydate',
        'airingStartMax' => 'fuzzydate',
        'airingFinish' => 'fuzzydate',
        'airingFinishMin' => 'fuzzydate',
        'airingFinishMax' => 'fuzzydate',
        'season' => 'array_string',
        ...
        'birthdayUntilMin' => 'fuzzydate',
        'birthdayUntilMax' => 'fuzzydate',
        'deathdayFrom' => 'fuzzydate',
        'deathdayFromMin' => 'fuzzydate',
        'deathdayFromMax' => 'fuzzydate',
        'deathdayUntil' => 'fuzzydate',
        'deathdayUntilMin' => 'fuzzydate',
        'deathdayUntilMax' => 'fuzzydate',
        'userStartFrom' => 'fuzzydate',
        'userStartFromMin' => 'fuzzydate',
        'userStartFromMax' => 'fuzzydate',
        'userFinishUntil' => 'fuzzydate',
        'userFinishUntilMin' => 'fuzzydate',
        'userFinishUntilMax' => 'fuzzydate',
        'meanScoreMin' => 'int',
        'meanScoreMax' => 'int',
        'avgScoreMin' => 'int',
        'avgScoreMax' => 'int',
